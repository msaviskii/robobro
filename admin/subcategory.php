...
if(isset($_GET['subcategory'])){$subcategory = abs(intval($_GET['subcategory']));}else{$subcategory = '1';}
...
<input type="text" placeholder="Название товара" class="form-control" name="subcat">
</div><br />
<div class="input-group input-group-lg">
<span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span> </span>
<input type="text" placeholder="Цена адресов" class="form-control" name="amount">
</div><br />
...
<ol class="breadcrumb">
  <li><a href="/admin">Админ-панель</a></li>
  <li><a href="subcategory.php?category=<?=$category;?>"><?=$cat['name'];?></a></li>
  <li class="active">Удаление товара: <b><?=$subcat['name'];?></b></li>
</ol>
<div class="alert alert-danger">Будут удалены все адреса из данного товара!</div>
...
<span class="glyphicon glyphicon-plus-sign"></span> Создать товар
</a>
</div>
<?
...
if(count($total) == 0){
echo '<div class="alert alert-danger">В данном городе нет товаров!</div>';
}
