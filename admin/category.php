...
<ol class="breadcrumb">
  ...
  <li><a href="category.php">Города</a></li>
  <li class="active">Создание Города</li>
</ol>
<?
...
<input type="text" placeholder="Название города" class="form-control" name="cat" value="">
</div>
<br />
...
<ol class="breadcrumb">
  <li><a href="/admin">Админ-панель</a></li>
  <li><a href="category.php">Города</a></li>
  <li class="active">Удаление города: <b><?=$cat['name'];?></b></li>
</ol>
<div class="alert alert-danger">Будут удалены все товары данного города и адреса из всех товаров данного города!</div>
...
<ol class="breadcrumb">
  <li><a href="/admin">Админ-панель</a></li>
  <li><a href="category.php">Города</a></li>
  <li class="active">Удаление всех проданных адресов</b></li>
</ol>
<div class="alert alert-danger">Будут удалены все проданные адреса из всех городов!</div>

<div class="btn-group">
  <button type="button" class="btn btn-danger dropdown-toggle" data-loading-text="Думаем" data-toggle="dropdown">Вы уверены? <span class="caret"></span></button>
  <ul class="dropdown-menu" role="menu">
    <li><a href="?cmd=remove_sale&ok">Да, удалить все проданные адреса</a></li>
    <li class="divider"></li>
    <li><a href="category.php">Нет, отменить</a></li>
  </ul>
</div><br /><br />
...
<span class="glyphicon glyphicon-plus-sign"></span> Создать город
</a>
</div>
<?
...
if(count($total) == 0){
echo '<div class="alert alert-danger">Нет городов!</div>';
}	
...
<span class="glyphicon glyphicon-remove"></span> Удалить все проданные адреса
</a>
</div>
<?
}
