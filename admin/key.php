...
$My_Class->title("Товар: ".$subcat['name']);
...
<input type="text" placeholder="Адрес" class="form-control" name="key">
</div><br>
...
<div class="input-group input-group-lg">
<span class="input-group-addon"><span class="glyphicon glyphicon-qrcode"></span> </span>
<input type="file" placeholder="Адрес" class="form-control" name="txt">
</div><br>
...
<span class="glyphicon glyphicon-plus-sign"></span> Добавить 1 адрес
</a>
</div>
<div class="list-group">
...
if(count($total) == 0){
echo '<div class="alert alert-danger">В данном товаре нет адресов!</div>';
}	
