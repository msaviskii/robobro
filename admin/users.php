...
if($_POST['del'] == 1) {
	DB::$the->prepare("DELETE FROM sel_users WHERE chat=? ")->execute(array(intval($_GET['chat']))); 
}
...
Удалить?
<label class="radio"> 
  <input type="radio" name="del" class="form-control" value="1">
   Да
</label>
<hr>
<label class="radio">
  <input type="radio" name="del" class="form-control" value="0" checked>
  Нет
</label>
<hr>
